...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // ---- Remote (APNs) push registration ----
    // The @capacitor/push-notifications plugin calls registerForRemoteNotifications(); these two
    // forward the OS callbacks to the plugin via NotificationCenter so JS receives the device token.
